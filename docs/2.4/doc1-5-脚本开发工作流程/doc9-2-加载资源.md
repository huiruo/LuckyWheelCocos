...
![alt text](https://docs.cocos.com/creator/2.4/manual/assets/resources-file-tree.3A-sLnbB.png)
...
注意：从 v2.4 开始，cc.loader 等接口不再建议使用，请使用最新的 cc.assetManager 相关接口，升级文档请参考 资源加载升级指南。
...
![alt text](https://docs.cocos.com/creator/2.4/manual/assets/asset-dep.B8Jcdu1u.png)

### 8-2.接下来要介绍问题的另一个核心：JavaScript 中无法跟踪对象引用。
...
### 8-2.最后一个值得关注的要点：JavaScript 的垃圾回收是延迟的。
